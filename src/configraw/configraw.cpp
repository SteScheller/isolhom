...
*/
std::vector<cr::bin_t> cr::bucketVolumeData(
    const VolumeDataBase &volumeData,
    size_t numBins,
    float min,
    float max)
{
    std::vector<cr::bin_t> bins(0);
    ...
    switch(volumeConfig.getVoxelType())
    {
        ...
        case Datatype::unsigned_halfword:
            bins = binData<unsigned_halfword_t>(
                numBins,
        ...
        case Datatype::signed_halfword:
            bins = binData<signed_halfword_t>(
                numBins,
        ...
        case Datatype::unsigned_longword:
            bins = binData<unsigned_longword_t>(
                numBins,
        ...
        case Datatype::signed_longword:
            bins = binData<signed_longword_t>(
                numBins,
        ...
        case Datatype::single_precision_float:
            bins = binData<single_precision_float_t>(
                numBins,
        ...
        case Datatype::double_precision_float:
            bins = binData<double_precision_float_t>(
                numBins,
